...
mvn install:install-file -DgroupId=com.exlibris -DartifactId=dps-sdk -Dversion=5.5.0 -Dpackaging=jar -DpomFile=wct-store/etc/lib/dps-sdk-5.5.0-pom.xml -Dfile=wct-store/etc/lib/dps-sdk-5.5.0.jar
