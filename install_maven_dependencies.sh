...
mvn install:install-file -DgroupId=com.exlibris -DartifactId=dps-sdk -Dversion=2.0.0 -Dpackaging=jar -Dfile=wct-store/etc/lib/dps-sdk-2.0.0.jar
...
mvn install:install-file -DgroupId=jbossall-client -DartifactId=jbossall-client -Dversion=4.2.2.ga -Dpackaging=jar -Dfile=wct-store/etc/lib/jbossall-client-4.2.2.ga.jar
mvn install:install-file -DgroupId=jboss-jaxws-jbossws -DartifactId=jboss-jaxws-jbossws -Dversion=2.0 -Dpackaging=jar -Dfile=wct-store/etc/lib/jboss-jaxws-jbossws-2.0.jar
mvn install:install-file -DgroupId=jbossws-client-jbossws -DartifactId=jbossws-client-jbossws -Dversion=2.0 -Dpackaging=jar -Dfile=wct-store/etc/lib/jbossws-client-jbossws-2.0.jar
mvn install:install-file -DgroupId=jbossws-common-jbossws -DartifactId=jbossws-common-jbossws -Dversion=2.0 -Dpackaging=jar -Dfile=wct-store/etc/lib/jbossws-common-jbossws-2.0.jar
mvn install:install-file -DgroupId=jbossws-spi -DartifactId=jbossws-spi -Dversion=4.2.2 -Dpackaging=jar -Dfile=wct-store/etc/lib/jbossws-spi-4.2.2.jar
mvn install:install-file -DgroupId=jboss-xml-binding -DartifactId=jboss-xml-binding -Dversion=1.0.0.SP1 -Dpackaging=jar -Dfile=wct-store/etc/lib/jboss-xml-binding-1.0.0.SP1.jar
mvn install:install-file -DgroupId=jboss-saaj -DartifactId=jboss-saaj -Dversion=4.2.2 -Dpackaging=jar -Dfile=wct-store/etc/lib/saaj.jar
