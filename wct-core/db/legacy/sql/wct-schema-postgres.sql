...
alter table DB_WCT.ABSTRACT_TARGET drop constraint FK_AT_RR_OID;
...
alter table DB_WCT.ABSTRACT_TARGET_GROUPTYPE_VIEW drop constraint FK7E62251C5C2C497;
alter table DB_WCT.ABSTRACT_TARGET_GROUPTYPE_VIEW drop constraint FK7E62251C3A83A603;
alter table DB_WCT.ABSTRACT_TARGET_GROUPTYPE_VIEW drop constraint FK_T_PROF_OVERRIDE_OID;
alter table DB_WCT.ABSTRACT_TARGET_GROUPTYPE_VIEW drop constraint FK_AT_DUBLIN_CORE_OID;
...
alter table DB_WCT.FLAG drop constraint FK_F_AGENCY_OID;
alter table DB_WCT.GROUP_MEMBER drop constraint FK100C647A8709EEA0;
...
alter table DB_WCT.HARVEST_RESULT drop constraint FK_HR_RR_OID;
...
alter table DB_WCT.INDICATOR drop constraint FK7BA7CDEF650FF8DE;
alter table DB_WCT.INDICATOR drop constraint FK_I_AGENCY_OID;
alter table DB_WCT.INDICATOR drop constraint FK_I_IC_OID;
alter table DB_WCT.INDICATOR_CRITERIA drop constraint FK_IC_AGENCY_OID;
alter table DB_WCT.INDICATOR_REPORT_LINE drop constraint FK_IRL_I_OID;
...
alter table DB_WCT.REJECTION_REASON drop constraint FK_RR_AGENCY_OID;
...
alter table DB_WCT.SCHEDULE drop constraint FK50C8297D8011641;
...
alter table DB_WCT.SEED_HISTORY drop constraint FKC8D0DCA697ECA972;
...
alter table DB_WCT.SITE drop constraint FK26D7478F713DAE;
...
alter table DB_WCT.TARGET_INSTANCE drop constraint FK_F_OID;
alter table DB_WCT.TARGET_INSTANCE drop constraint FKFC6B0383F9407D62;
...
drop table DB_WCT.HEATMAP_CONFIG;
drop table DB_WCT.HR_MODIFICATION_NOTE;
drop table DB_WCT.INDICATOR;
drop table DB_WCT.INDICATOR_CRITERIA;
drop table DB_WCT.INDICATOR_REPORT_LINE;
...
create table DB_WCT.AGENCY (AGC_OID int8 not null, AGC_NAME varchar(80) not null unique, AGC_ADDRESS varchar(255) not null, AGC_LOGO_URL varchar(255), AGC_URL varchar(255), AGC_EMAIL varchar(80), AGC_FAX varchar(20), AGC_PHONE varchar(20), AGC_SHOW_TASKS bool, AGC_DEFAULT_DESC_TYPE varchar(255), primary key (AGC_OID));
create table DB_WCT.ANNOTATIONS (AN_OID int8 not null, AN_DATE timestamp not null, AN_NOTE varchar(1000) not null, AN_USER_OID int8 not null, AN_OBJ_OID int8 not null, AN_OBJ_TYPE varchar(500) not null, AN_ALERTABLE bool, primary key (AN_OID));
...
create table DB_WCT.BANDWIDTH_RESTRICTIONS (BR_OID int8 not null, BR_BANDWIDTH int8 not null, BR_DAY varchar(9) not null, BR_END_TIME timestamp not null, BR_START_TIME timestamp not null, BR_OPTIMIZATION_ALLOWED bool, primary key (BR_OID));
...
create table DB_WCT.FLAG (F_OID int8 not null, F_NAME varchar(255) not null, F_RGB varchar(255) not null, F_COMPLEMENT_RGB varchar(255) not null, F_AGC_OID int8 not null, primary key (F_OID));
...
create table DB_WCT.HARVEST_RESULT (HR_OID int8 not null, HR_HARVEST_NO int4, HR_TARGET_INSTANCE_ID int8, HR_PROVENANCE_NOTE varchar(1024) not null, HR_CREATED_DATE timestamp, HR_CREATED_BY_ID int8, HR_RR_OID int8, HR_STATE int4, HR_DERIVED_FROM int4, HR_INDEX int4, primary key (HR_OID));
...
create table DB_WCT.INDICATOR (I_OID int8 not null, I_IC_OID int8 not null, I_NAME varchar(255) not null, I_TI_OID int8, I_FLOAT_VALUE float4 not null, I_UPPER_LIMIT_PERCENTAGE float4, I_LOWER_LIMIT_PERCENTAGE float4, I_UPPER_LIMIT float4, I_LOWER_LIMIT float4, I_ADVICE varchar(255), I_JUSTIFICATION varchar(255), I_AGC_OID int8 not null, I_UNIT varchar(255) not null, I_SHOW_DELTA bool not null, I_DATE TIMESTAMP(9) not null, I_INDEX int4, primary key (I_OID));
create table DB_WCT.INDICATOR_CRITERIA (IC_OID int8 not null, IC_NAME varchar(255) not null, IC_DESCRIPTION varchar(255), IC_UPPER_LIMIT_PERCENTAGE float4, IC_LOWER_LIMIT_PERCENTAGE float4, IC_UPPER_LIMIT float4, IC_LOWER_LIMIT float4, IC_AGC_OID int8 not null, IC_UNIT varchar(255) not null, IC_SHOW_DELTA bool not null, IC_ENABLE_REPORT bool not null, primary key (IC_OID));
create table DB_WCT.INDICATOR_REPORT_LINE (IRL_OID int8 not null, IRL_I_OID int8, IRL_LINE varchar(255), IRL_INDEX int4, primary key (IRL_OID));
...
create table DB_WCT.PERMISSION (PE_OID int8 not null, PE_ACCESS_STATUS varchar(255), PE_APPROVED_YN bool, PE_AVAILABLE_YN bool, PE_COPYRIGHT_STATEMENT varchar(2048), PE_COPYRIGHT_URL varchar(2048), PE_CREATION_DATE TIMESTAMP(9) NULL, PE_END_DATE TIMESTAMP(9) NULL, PE_NOTES text, PE_OPEN_ACCESS_DATE TIMESTAMP(9) NULL, PE_PERMISSION_GRANTED_DATE TIMESTAMP(9) NULL, PE_PERMISSION_REQUESTED_DATE TIMESTAMP(9) NULL, PE_SPECIAL_REQUIREMENTS varchar(2048), PE_START_DATE TIMESTAMP(9) NULL, PE_STATUS int4, PE_AUTH_AGENT_ID int8, PE_SITE_ID int8, PE_QUICK_PICK bool, PE_DISPLAY_NAME varchar(32), PE_OWNING_AGENCY_ID int8, PE_FILE_REFERENCE varchar(255), primary key (PE_OID));
...
create table DB_WCT.PERMISSION_TEMPLATE (PRT_OID int8 not null, PRT_AGC_OID int8 not null, PRT_TEMPLATE_TEXT text not null, PRT_TEMPLATE_NAME varchar(80) not null, PRT_TEMPLATE_TYPE varchar(40) not null, PRT_TEMPLATE_DESC varchar(255), PRT_TEMPLATE_SUBJECT varchar(255), PRT_TEMPLATE_OVERWRITE_FROM bool not null, PRT_TEMPLATE_FROM varchar(255), PRT_TEMPLATE_CC varchar(2048), PRT_TEMPLATE_BCC varchar(2048), PRT_TEMPLATE_REPLY_TO varchar(255), primary key (PRT_OID));
...
create table DB_WCT.REJECTION_REASON (RR_OID int8 not null, RR_NAME varchar(100) not null, RR_AGC_OID int8 not null, RR_AVAILABLE_FOR_TARGET bool, RR_AVAILABLE_FOR_TI bool, primary key (RR_OID));
...
create table DB_WCT.SCHEDULE (S_OID int8 not null, S_CRON varchar(255) not null, S_START TIMESTAMP(9) not null, S_END TIMESTAMP(9) NULL, S_TARGET_ID int8, S_TYPE int4 not null, S_OWNER_OID int8, S_NEXT_SCHEDULE_TIME TIMESTAMP(9) NULL, S_LAST_PROCESSED_DATE TIMESTAMP(9) NULL, S_ABSTRACT_TARGET_ID int8, primary key (S_OID));
create table DB_WCT.SEED (S_OID int8 not null, S_SEED varchar(1024), S_TARGET_ID int8, S_PRIMARY bool, primary key (S_OID));
create table DB_WCT.SEED_HISTORY (SH_OID int8 not null, SH_SEED varchar(1024), SH_TI_OID int8, SH_PRIMARY bool, primary key (SH_OID));
...
create table DB_WCT.SITE (ST_OID int8 not null, ST_TITLE varchar(255) not null unique, ST_DESC varchar(4000), ST_LIBRARY_ORDER_NO varchar(32), ST_NOTES text, ST_PUBLISHED bool not null, ST_CREATION_DATE TIMESTAMP(9) NULL, ST_ACTIVE bool not null, ST_OWNING_AGENCY_ID int8, primary key (ST_OID));
...
create table DB_WCT.TARGET (T_AT_OID int8 not null, T_RUN_ON_APPROVAL bool, T_USE_AQA bool, T_EVALUATION_NOTE varchar(255), T_SELECTION_DATE TIMESTAMP(9) NULL, T_SELECTION_NOTE varchar(255), T_SELECTION_TYPE varchar(255), T_HARVEST_TYPE varchar(255), T_ALLOW_OPTIMIZE bool, primary key (T_AT_OID));
...
create table DB_WCT.TARGET_INSTANCE (TI_OID int8 not null, TI_VERSION int4 not null, TI_SCHEDULE_ID int8, TI_TARGET_ID int8, TI_PRIORITY int4 not null, TI_SCHEDULED_TIME TIMESTAMP(9) not null, TI_STATE varchar(50) not null, TI_BANDWIDTH_PERCENT int4, TI_ALLOCATED_BANDWIDTH int8, TI_START_TIME timestamp, TI_ARCHIVED_TIME timestamp, TI_OWNER_ID int8, TI_DISPLAY_ORDER int4, TI_PROF_OVERRIDE_OID int8, TI_PROFILE_ID int8, TI_PURGED bool not null, TI_ARCHIVE_ID varchar(40) unique, TI_REFERENCE varchar(255), TI_HARVEST_SERVER varchar(255), TI_DISPLAY_TARGET_INSTANCE bool, TI_DISPLAY_NOTE varchar(4000), TI_DISPLAY_CHG_REASON varchar(1000), TI_FLAGGED bool, TI_FLAG_OID int8, TI_USE_AQA bool, TI_FIRST_FROM_TARGET bool, TI_RECOMMENDATION varchar(255), TI_ALLOW_OPTIMIZE bool, primary key (TI_OID));
...
create table DB_WCT.URL_PERMISSION_MAPPING_VIEW (UPM_OID int8 not null, PE_END_DATE TIMESTAMP(9) NULL, UP_PATTERN varchar(2048), PE_OWNING_AGENCY_ID int8, PE_OID int8, ST_ACTIVE bool not null, UPM_DOMAIN varchar(1024), primary key (UPM_OID));
...
alter table DB_WCT.ABSTRACT_TARGET_GROUPTYPE_VIEW add constraint FK7E62251C5C2C497 foreign key (AT_OWNER_ID) references DB_WCT.WCTUSER;
alter table DB_WCT.ABSTRACT_TARGET_GROUPTYPE_VIEW add constraint FK7E62251C3A83A603 foreign key (T_PROFILE_ID) references DB_WCT.PROFILE;
alter table DB_WCT.ABSTRACT_TARGET_GROUPTYPE_VIEW add constraint FK_T_PROF_OVERRIDE_OID foreign key (AT_PROF_OVERRIDE_OID) references DB_WCT.PROFILE_OVERRIDES;
alter table DB_WCT.ABSTRACT_TARGET_GROUPTYPE_VIEW add constraint FK_AT_DUBLIN_CORE_OID foreign key (AT_DUBLIN_CORE_OID) references DB_WCT.DUBLIN_CORE;
...
alter table DB_WCT.FLAG add constraint FK_F_AGENCY_OID foreign key (F_AGC_OID) references DB_WCT.AGENCY;
alter table DB_WCT.GROUP_MEMBER add constraint FK100C647A8709EEA0 foreign key (GM_CHILD_ID) references DB_WCT.ABSTRACT_TARGET_GROUPTYPE_VIEW;
...
alter table DB_WCT.HARVEST_RESULT add constraint FK_HR_RR_OID foreign key (HR_RR_OID) references DB_WCT.REJECTION_REASON;
...
alter table DB_WCT.INDICATOR add constraint FK7BA7CDEF650FF8DE foreign key (I_TI_OID) references DB_WCT.TARGET_INSTANCE;
alter table DB_WCT.INDICATOR add constraint FK_I_AGENCY_OID foreign key (I_AGC_OID) references DB_WCT.AGENCY;
alter table DB_WCT.INDICATOR add constraint FK_I_IC_OID foreign key (I_IC_OID) references DB_WCT.INDICATOR_CRITERIA;
alter table DB_WCT.INDICATOR_CRITERIA add constraint FK_IC_AGENCY_OID foreign key (IC_AGC_OID) references DB_WCT.AGENCY;
alter table DB_WCT.INDICATOR_REPORT_LINE add constraint FK_IRL_I_OID foreign key (IRL_I_OID) references DB_WCT.INDICATOR;
...
alter table DB_WCT.REJECTION_REASON add constraint FK_RR_AGENCY_OID foreign key (RR_AGC_OID) references DB_WCT.AGENCY;
...
alter table DB_WCT.SCHEDULE add constraint FK50C8297D8011641 foreign key (S_ABSTRACT_TARGET_ID) references DB_WCT.ABSTRACT_TARGET_GROUPTYPE_VIEW;
...
alter table DB_WCT.SEED_HISTORY add constraint FKC8D0DCA697ECA972 foreign key (SH_TI_OID) references DB_WCT.TARGET_INSTANCE;
...
alter table DB_WCT.SITE add constraint FK26D7478F713DAE foreign key (ST_OWNING_AGENCY_ID) references DB_WCT.AGENCY;
...
alter table DB_WCT.TARGET_INSTANCE add constraint FK_F_OID foreign key (TI_FLAG_OID) references DB_WCT.FLAG;
alter table DB_WCT.TARGET_INSTANCE add constraint FKFC6B0383F9407D62 foreign key (TI_PROFILE_ID) references DB_WCT.PROFILE;
