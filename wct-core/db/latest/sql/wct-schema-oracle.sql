...
create table DB_WCT.PROFILE (P_OID number(19,0) not null, P_VERSION number(10,0) not null, P_DESC varchar2(255), P_NAME varchar2(255), P_PROFILE_STRING clob, P_PROFILE_LEVEL number(10,0), P_STATUS number(10,0), P_DEFAULT number(1,0), P_AGECNY_OID number(19,0), P_ORIG_OID number(19,0), P_HARVESTER_TYPE varchar2(40) not null, P_DATA_LIMIT_UNIT varchar2(40), P_MAX_FILE_SIZE_UNIT varchar2(40), P_TIME_LIMIT_UNIT varchar2(40), primary key (P_OID));
