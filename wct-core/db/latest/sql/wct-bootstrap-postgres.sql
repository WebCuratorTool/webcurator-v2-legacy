...
insert into DB_WCT.WCTUSER (USR_OID, USR_ACTIVE, USR_EMAIL, USR_EXTERNAL_AUTH, USR_FIRSTNAME, USR_LASTNAME, USR_NOTIFICATIONS_BY_EMAIL, USR_PASSWORD, USR_USERNAME, USR_FORCE_PWD_CHANGE, USR_AGC_OID, USR_TASKS_BY_EMAIL,  USR_NOTIFY_ON_GENERAL,  USR_NOTIFY_ON_WARNINGS) values (0, true, 'bootstrap@sytec.co.nz', false, 'System', 'Bootstrap', false, '2cef312836577798919e66999e80487a349b83bd', 'bootstrap', false,0,false,false,false);
...
insert into DB_WCT.ROLE_PRIVILEGE (PRV_OID, PRV_CODE, PRV_ROLE_OID, PRV_SCOPE) values (-5,'MANAGE_PROFILES',0,0);
insert into DB_WCT.ROLE_PRIVILEGE (PRV_OID, PRV_CODE, PRV_ROLE_OID, PRV_SCOPE) values (-6,'VIEW_PROFILES',0,0);