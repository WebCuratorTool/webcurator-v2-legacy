...
create table DB_WCT.PROFILE (P_OID bigint not null, P_VERSION integer not null, P_DESC varchar(255), P_NAME varchar(255), P_PROFILE_STRING text, P_PROFILE_LEVEL integer, P_STATUS integer, P_DEFAULT bit, P_AGECNY_OID bigint, P_ORIG_OID bigint, P_HARVESTER_TYPE varchar(40) not null, P_DATA_LIMIT_UNIT varchar(40), P_MAX_FILE_SIZE_UNIT varchar(40), P_TIME_LIMIT_UNIT varchar(40), primary key (P_OID));
