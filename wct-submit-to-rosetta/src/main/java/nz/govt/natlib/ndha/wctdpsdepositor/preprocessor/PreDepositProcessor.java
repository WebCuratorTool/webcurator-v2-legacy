...
@ImplementedBy(ArcIndexProcessor.class)
public interface PreDepositProcessor {

    public abstract File process(WctDataExtractor data);
    public abstract File process(String tempDirectory, WctDataExtractor data);
