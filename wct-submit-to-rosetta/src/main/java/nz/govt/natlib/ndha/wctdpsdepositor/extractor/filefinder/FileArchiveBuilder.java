...
/**
 * Interface for finding files referenced in a Wct Met's document. 
 */
public interface FileArchiveBuilder {

    FileSystemArchiveFile createFileFrom(String mimeType, String expectedCheckSum, String fileName);
